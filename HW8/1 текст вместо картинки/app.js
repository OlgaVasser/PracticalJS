...
function handleClick(clickedButtonEvent) {
  ...
  const cardButton = cardNode.querySelector("button");
...
function showMoreText(card) {
  ...
  const text = "Это инфо о продукте";
