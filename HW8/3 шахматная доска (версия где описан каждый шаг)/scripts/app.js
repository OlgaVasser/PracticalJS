let app = {
  ...
  insertPawns() {
    ...
    let whitePawnsRow = document.querySelectorAll("tr:nth-of-type(7) td");
    ...
    let blackPawnsRow = document.querySelectorAll("tr:nth-of-type(2) td");
  ...
  insertFiguresOnDesk() {
    ...
    for (let i = 0; i < positions.length; i++) {
      ...
      let cell = document.querySelector(
        `[data-rownum="${positions[i].coordRow}"][data-colchar="${positions[i].coordCol}"]`
      );
